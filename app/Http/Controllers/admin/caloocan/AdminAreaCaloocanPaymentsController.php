...
{
    public function AdminAreaCaloocanClientPaymentsPage($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view('admin.areas.caloocan.payments.payments', compact('area', 'collectors', 'payments'));
    }

    public function AdminAreaCaloocanPrintSummaryCollections(Request $request, $areaId)
    {
        ...
        return view(
            'admin.areas.caloocan.payments.print.print_payments',
    ...
    public function AdminAreaCaloocanClientPaymentsRequest(Request $request, $id)
    {
    ...
    public function AdminAreaCaloocanClientUpdateCollection(Request $request, $id)
    {
        $request->validate([
    ...
    public function AdminAreaCaloocanClientDailyPaymentsPage($referenceNumber)
    {
        $payments = DB::table('clients_payments')
            ->join('clients', 'clients.id', '=', 'clients_payments.client_id')
            ->join('clients_loans', 'clients_loans.id', '=', 'clients_payments.client_loans_id')
        ...
        return view(
            'admin.areas.caloocan.payments.daily_payments',
            compact('payments', 'referenceNumber')
        );
    }

    public function AdminAreaCaloocanClientPrintDailyPayments($referenceNumber)
    {
        $payments = DB::table('clients_payments')
            ->join('clients', 'clients.id', '=', 'clients_payments.client_id')
            ->join('clients_loans', 'clients_loans.id', '=', 'clients_payments.client_loans_id')
        ...
        return view(
            'admin.areas.caloocan.payments.print.print_daily_payments',
            compact('payments', 'referenceNumber', 'area')
        );
    }

    public function AdminAreaCaloocanCollectAllPayments(Request $request, $reference)
    {
        $request->validate([
    ...
    public function AdminAreaCaloocanRemindPaymentsByReference(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)
    ...
    public function AdminAreaCaloocanNoPaymentAll(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)

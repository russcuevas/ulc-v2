...
class AdminAreaFCClientsController extends Controller
{
    public function AdminAreaFCClientsPage($areaId)
    {
        ...
        return view(
            'admin.areas.fc.clients.view_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }


    public function AdminAreaFCRenewalClientPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.fc.clients.for_renewal_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }
    ...
    public function AdminAreaFCLapsedClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.fc.clients.lapsed_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function AdminAreaFCActiveClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.fc.clients.active_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }
    ...
    // PRINT QUERIES
    public function AdminAreaFCLapsedClientsPrint($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view(
            'admin.areas.fc.clients.print.print_lapsed',

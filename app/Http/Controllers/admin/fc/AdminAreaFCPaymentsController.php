...
class AdminAreaFCPaymentsController extends Controller
{
    ...
    public function AdminAreaFCCollectAllPayments(Request $request, $reference)
    {
        $request->validate([
    ...
    public function AdminAreaFCRemindPaymentsByReference(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)
    ...
    public function AdminAreaFCNoPaymentAll(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)

...
class AdminAreaValenzuelaClientsController extends Controller
{
    public function AdminAreaValenzuelaClientsPage($areaId)
    {
        ...
        return view(
            'admin.areas.valenzuela.clients.view_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }


    public function AdminAreaValenzuelaRenewalClientPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.valenzuela.clients.for_renewal_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }
    ...
    public function AdminAreaValenzuelaLapsedClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.valenzuela.clients.lapsed_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function AdminAreaValenzuelaActiveClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'admin.areas.valenzuela.clients.active_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }
    ...
    // PRINT QUERIES
    public function AdminAreaValenzuelaLapsedClientsPrint($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view(
            'admin.areas.valenzuela.clients.print.print_lapsed',

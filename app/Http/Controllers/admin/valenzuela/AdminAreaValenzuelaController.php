...
class AdminAreaValenzuelaController extends Controller
{
    public function AdminAreaValenzuelaPage()
    {
        ...
        return view('admin.areas.valenzuela.index', compact('areas'));
    }
    ...
    public function AdminAreaValenzuelaPaymentsPage()
    {
        return view('admin.areas.valenzuela.payments');
    }

    public function AdminAreaValenzuelaPrintSalesReports(Request $request)
    {
        ...
        return view('admin.areas.valenzuela.print.print_sales', [
            'loans'     => $loans,
            'from'      => $from,
            'to'        => $to,

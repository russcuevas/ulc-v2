...
class CaloocanCollectorPaymentController extends Controller
{
    public function CaloocanCollectorCollectionsPage($areaId)
    {
        ...
        if (!$area) {
            return redirect()->route('collector.caloocan.dashboard.page')
        ...
        return view('collector.caloocan.collections.index', compact('area', 'payments'));
    }

    public function CaloocanCollectorClientPaymentPage($referenceNumber)
    {
        $collectorId = Auth::guard('collector')->id();
        ...
        return view(
            'collector.caloocan.collections.payments',
            compact('payments', 'referenceNumber', 'area')
        );
    }

    public function CaloocanCollectorCollectRequest(Request $request, $id)
    {
        $request->validate([

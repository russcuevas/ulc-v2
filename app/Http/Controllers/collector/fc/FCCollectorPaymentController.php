...
class FCCollectorPaymentController extends Controller
{
    public function FCCollectorCollectionsPage($areaId)
    {
        ...
        if (!$area) {
            return redirect()->route('collector.fc.dashboard.page')
        ...
        return view('collector.fc.collections.index', compact('area', 'payments'));
    }

    public function FCCollectorClientPaymentPage($referenceNumber)
    {
        $collectorId = Auth::guard('collector')->id();
        ...
        return view(
            'collector.fc.collections.payments',
            compact('payments', 'referenceNumber', 'area')
        );
    }

    public function FCCollectorCollectRequest(Request $request, $id)
    {
        $request->validate([

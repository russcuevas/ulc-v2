...
class ManilaCollectorPaymentController extends Controller
{
    public function ManilaCollectorCollectionsPage($areaId)
    {
        ...
        if (!$area) {
            return redirect()->route('collector.manila.dashboard.page')
        ...
        return view('collector.manila.collections.index', compact('area', 'payments'));
    }

    public function ManilaCollectorClientPaymentPage($referenceNumber)
    {
        $collectorId = Auth::guard('collector')->id();
        ...
        return view(
            'collector.manila.collections.payments',
            compact('payments', 'referenceNumber', 'area')
        );
    }

    public function ManilaCollectorCollectRequest(Request $request, $id)
    {
        $request->validate([

...
class CaloocanAreaClientsController extends Controller
{
    public function CaloocanAreaClientsPage($areaId)
    {
        ...
        return view(
            'secretary.caloocan.areas.clients.view_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function CaloocanAreaLapsedClientsPrint($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view(
            'secretary.caloocan.areas.clients.print.print_lapsed',
            compact('area', 'clients', 'month', 'startOfMonth', 'endOfMonth')
        );
    }

    public function CaloocanAreaActiveClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.caloocan.areas.clients.active_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function CaloocanAreaRenewalClientPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.caloocan.areas.clients.for_renewal_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function CaloocanAreaLapsedClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.caloocan.areas.clients.lapsed_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

...
class CaloocanClientsRenewalController extends Controller
{
    public function CaloocanClientAddRenewalRequest(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $secretaryFullname, $client, $area) {
            ...
            Activity::create([
                ...
                'type'              => 'Loan Renewal',
                'description'       => sprintf(
                    '<strong>Secretary %s</strong> from Caloocan Area created a renewal loan.<br>

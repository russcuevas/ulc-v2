...
class FCAreaClientsController extends Controller
{
    public function FCAreaClientsPage($areaId)
    {
        ...
        return view(
            'secretary.fc.areas.clients.view_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function FCAreaLapsedClientsPrint($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view(
            'secretary.fc.areas.clients.print.print_lapsed',
            compact('area', 'clients', 'month', 'startOfMonth', 'endOfMonth')
        );
    }

    public function FCAreaActiveClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.fc.areas.clients.active_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function FCAreaRenewalClientPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.fc.areas.clients.for_renewal_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function FCAreaLapsedClientsPage($areaId)
    {
        $area = $this->getRelatedArea($areaId);
        ...
        return view(
            'secretary.fc.areas.clients.lapsed_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

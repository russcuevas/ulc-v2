...
class FCAreaController extends Controller
{
    public function FCAreaPage()
    {
        ...
        return view('secretary.fc.areas.index', compact('areas'));
    }
    ...
    public function FCAreaPrintSalesReports(Request $request)
    {
        ...
        return view('secretary.fc.areas.print.print_sales', [
            'loans'     => $loans,
            'from'      => $from,
            'to'        => $to,

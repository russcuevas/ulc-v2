...
class FCAreaPaymentsController extends Controller
{
    ...
    public function FCSecretaryCollectAllPayments(Request $request, $reference)
{
    $request->validate([
    ...
    DB::table('activities')->insert([
        ...
        'description'       => sprintf(
            ...
            <span style="font-size:12px;color:#6c757d;">Area: Financial Counselor - [%s]</span><br>
...
public function FCSecretaryRemindPaymentsByReference(Request $request, $reference)
{
    $payments = DB::table('clients_payments')
        ->where('reference_number', $reference)
        ->where('is_collected', 0)
    ...
    public function FCSecretaryNoPaymentAll(Request $request, $reference)
{
    $payments = DB::table('clients_payments')
        ->where('reference_number', $reference)
        ->where('is_collected', 0)

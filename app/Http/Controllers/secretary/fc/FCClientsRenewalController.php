...
class FCClientsRenewalController extends Controller
{
    public function FCClientAddRenewalRequest(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $secretaryFullname, $client, $area) {
            ...
            Activity::create([
                ...
                'type'              => 'Loan Renewal',
                'description'       => sprintf(
                    '<strong>Secretary %s</strong> from Financial Counselor created a renewal loan.<br>

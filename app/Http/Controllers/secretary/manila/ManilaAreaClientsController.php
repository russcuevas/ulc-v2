...
class ManilaAreaClientsController extends Controller
{
    public function ManilaAreaClientsPage($areaId)
    {
        ...
        return view(
            'secretary.manila.areas.clients.view_clients',
            array_merge(compact('clients', 'area'), $counts)
        );
    }

    public function ManilaAreaLapsedClientsPrint($areaId)
    {
        $area = DB::table('areas')
            ->where('id', $areaId)
        ...
        return view(
            'secretary.manila.areas.clients.print.print_lapsed',

...
class ManilaAreaPaymentsController extends Controller
{
    ...
    public function ManilaSecretaryCollectAllPayments(Request $request, $reference)
{
    $request->validate([
...
public function ManilaSecretaryRemindPaymentsByReference(Request $request, $reference)
{
    $payments = DB::table('clients_payments')
        ->where('reference_number', $reference)
        ->where('is_collected', 0)
    ...
    public function ManilaSecretaryNoPaymentAll(Request $request, $reference)
{
    $payments = DB::table('clients_payments')
        ->where('reference_number', $reference)
        ->where('is_collected', 0)

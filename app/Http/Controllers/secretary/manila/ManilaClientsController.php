...
class ManilaClientsController extends Controller
{
    public function ManilaClientsPage()
    {
        ...
        return view(
            'secretary.manila.client.index',
            compact('clients', 'areas')
        );
    }

    public function ManilaAddClientRequest(Request $request)
    {
        $request->validate([
    ...
    public function ManilaEditClientPage($id)
    {
        $user = Auth::user();
        ...
        return view(
            'secretary.manila.client.edit',
            compact('client', 'areas', 'loans', 'last_loans')
        );
    }

    public function ManilaUpdateClientRequest(Request $request, $id)
    {
        $request->validate([
            'fullname' => 'required|string|max:255',
            'phone' => 'required|digits:11',
    ...
    public function ManilaDeleteClientRequest(string $id)
    {
        $client = Clients::findOrFail($id);

...
$due_date = $request->due_date;
    ...
    public function ValenzuelaSecretaryCollectAllPayments(Request $request, $reference)
    {
        $request->validate([
    ...
    public function ValenzuelaSecretaryRemindPaymentsByReference(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)
        ...
        public function ValenzuelaSecretaryNoPaymentAll(Request $request, $reference)
    {
        $payments = DB::table('clients_payments')
            ->where('reference_number', $reference)
            ->where('is_collected', 0)

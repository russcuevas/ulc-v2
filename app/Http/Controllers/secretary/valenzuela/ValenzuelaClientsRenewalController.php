...
class ValenzuelaClientsRenewalController extends Controller
{
    public function ValenzuelaClientAddRenewalRequest(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $secretaryFullname, $client, $area) {
            ...
            Activity::create([
                ...
                'type'              => 'Loan Renewal',
                'description'       => sprintf(
                    '<strong>Secretary %s</strong> from Valenzuela Area created a renewal loan.<br>

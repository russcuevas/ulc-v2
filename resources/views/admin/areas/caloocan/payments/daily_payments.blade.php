                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm border-1">
                        ...
                        <div class="m-4 text-end" style="margin-top: 0px !important;">
                            <a href="{{ route('admin.area.caloocan.payments.print', $referenceNumber) }}"
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="d-flex flex-column align-items-end gap-2 mb-3 mt-5">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        ...
                                        {{-- Collect All --}}
                                        <form method="POST"
                                            action="{{ route('admin.caloocan.collect.all', $referenceNumber) }}"
                                        ...
                                        {{-- Remind Payment --}}
                                        <form method="POST"
                                            action="{{ route('admin.caloocan.payments.remind.by.reference', $referenceNumber) }}"
                                        ...
                                        {{-- No Payment --}}
                                        <form method="POST"
                                            action="{{ route('admin.caloocan.no-payment.all', $referenceNumber) }}"
    ...
    <script>
        document.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                fetch(`/admin/areas/caloocan/${paymentId}/update-collection`, {
                        method: 'POST',
                        headers: {

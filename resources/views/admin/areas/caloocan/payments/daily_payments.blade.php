    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = `/admin/areas/caloocan/collect-payment/${paymentId}`;
        ...
        $(document).on('click', '.remind-payment-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = `/admin/areas/caloocan/remind-payment/${paymentId}`;
        ...
        $(document).on('click', '.no-payment-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = `/admin/areas/caloocan/no-payment/${paymentId}`;

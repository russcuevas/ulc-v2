            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-map me-1"></i>
                        Areas</li>
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-location-dot me-1"></i>
                        Financial Counselor</li>
                </ol>
            </nav>
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        @foreach ($areas as $area)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.area.fc.payments', $area->id) }}"
    ...
    <script>
        ...
        `,
                ...
                preConfirm: () => {
                    ...
                    form.method = 'GET';
                    form.action = "{{ route('admin.area.fc.print.sales') }}";
                    form.target = '_blank';

                    ...
                    <div class="card shadow-sm border-1">
                        <div class="d-flex justify-content-between align-items-start m-4">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                <form action="{{ route('areas.area.fc.payments.request', $area->id) }}" method="POST">
                                    @csrf
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.area.fc.payments.clients', $payment->reference_number) }}"
        ...
        document.getElementById('openDatePicker').addEventListener('click', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = "{{ route('areas.area.fc.payments.request', $area->id) }}";
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'GET';
                    form.action =
                        "{{ route('admin.area.fc.payments.print.summary.collections', $area->id) }}";
                    form.target = '_blank';

            ...
            `,
                ...
                didOpen: () => {
                    ...
                    document.getElementById('print-all').addEventListener('click', function() {
                        ...
                        window.open(
                            `/admin/areas/valenzuela/${areaId}/clients/print?month=${month}`,
                            '_blank'
                        );
                    });
                    ...
                    document.getElementById('print-active').addEventListener('click', function() {
                        ...
                        window.open(
                            `/admin/areas/valenzuela/${areaId}/clients/active/print?month=${month}`,
                            '_blank'
                        );
                    });
                    ...
                    document.getElementById('print-lapsed').addEventListener('click', function() {
                        ...
                        window.open(
                            `/admin/areas/valenzuela/${areaId}/clients/lapsed/print?month=${month}`,
                            '_blank'
                        );
                    });
                }

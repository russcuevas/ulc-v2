        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.area.valenzuela.page') }}"
                    ...
                    <div class="card shadow-sm border-1">
                        <div class="d-flex justify-content-between align-items-start m-4">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                <form action="{{ route('areas.area.valenzuela.payments.request', $area->id) }}"
                                    method="POST">
                                    @csrf
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.area.valenzuela.payments.clients', $payment->reference_number) }}"
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'GET';
                    form.action =
                        "{{ route('admin.area.valenzuela.payments.print.summary.collections', $area->id) }}";
                    form.target = '_blank';

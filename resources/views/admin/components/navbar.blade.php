        ...
        <nav class="navbar navbar-expand-lg bg-body shadow-sm d-lg-none mb-3 sticky-top">
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="dropdown">
                        <button class="icon-btn position-relative" id="notificationMobileBtn" data-bs-toggle="dropdown">
                            ...
                            <span id="notificationMobileCount"
        ...
        <header
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="icon-btn position-relative" id="notificationBtn" data-bs-toggle="dropdown">
                        <svg width="20" fill="currentColor" viewBox="0 0 448 512">
                            <path
                                d="M224 0c-17.7 0-32 14.3-32 32V49.9C119.5 61.4 64 124.2 64 200v33.4c0 45.4-15.5 89.5-43.8 124.9L5.3 377c-5.8 7.2-6.9 17.1-2.9 25.4S14.8 416 24 416H424c9.2 0 17.6-5.3 21.6-13.6s2.9-18.2-2.9-25.4l-14.9-18.6C399.5 322.9 384 278.8 384 233.4V200c0-75.8-55.5-138.6-128-150.1V32c0-17.7-14.3-32-32-32z" />
                        </svg>
                ...
                <div class="dropdown">
                    <div class="user-avatar" data-bs-toggle="dropdown" aria-expanded="false">{{ $user_initials }}
                    </div>
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item d-flex gap-2 align-items-center"
                                href="{{ route('admin.profile.page') }}">Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function initNotifications(listId, countId) {
                    ...
                    function load() {
                        ...
                        `;
                                    ...
                                    data.notifications.forEach(n => {
                                        const dotClass = n.is_read_admin == 0 ? 'notif-dot unread' :
                                            'notif-dot';
                ...
                initNotifications('notificationList', 'notificationCount');
                initNotifications('notificationMobileList', 'notificationMobileCount');

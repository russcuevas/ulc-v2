        ...
        <div id="sidebarContent" class="d-none">
            ...
            <div class="nav flex-column nav-pills px-3 mt-2">
                <a href="{{ route('collector.valenzuela.dashboard.page') }}"
                    class="nav-link {{ request()->routeIs('collector.valenzuela.dashboard.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-house"></i>
                    Dashboard
                </a>

                <a href="{{ route('collector.valenzuela.collections.page', $area->id) }}"
                    class="nav-link {{ request()->routeIs('collector.valenzuela.collections.page', 'collector.valenzuela.collections.payments') ? 'active' : '' }}">

                        ...
                        <div class="d-flex justify-content-between align-items-start m-4">
                            ...
                            <h5 class="card-title mb-0">
                                ...
                                <span style="color: #ff6b35">
                                    Caloocan [{{ $area->area_name }}]
                                </span>
                            </h5>

                            <!-- RIGHT: Buttons -->
                            <div class="d-flex flex-column align-items-end">
                                <form action="{{ route('secretary.area.caloocan.payments.request', $area->id) }}"
                                    method="POST">
                                    @csrf
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('secretary.area.caloocan.payments.clients', $payment->reference_number) }}"
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'GET';
                    form.action =
                        "{{ route('secretary.area.caloocan.payments.print.summary.collections', $area->id) }}";
                    form.target = '_blank';

        ...
        <div id="sidebarContent" class="d-none">
            ...
            <div class="nav flex-column nav-pills px-3 mt-2">
                <a href="{{ route('secretary.caloocan.dashboard.page') }}"
                    class="nav-link {{ request()->routeIs('secretary.caloocan.dashboard.page', 'secretary.caloocan.analytics.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-house"></i>
                    Dashboard
                </a>

                <a href="{{ route('secretary.caloocan.clients.page') }}"
                    class="nav-link 
                    {{ request()->routeIs('secretary.caloocan.clients.page', 'secretary.caloocan.edit.clients.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-users"></i>
                    Clients
                </a>
                <a href="{{ route('secretary.caloocan.area.page') }}"
                    class="nav-link 
                    {{ request()->routeIs(
                        'secretary.caloocan.area.page',
                        'secretary.area.caloocan.payments',
                        'secretary.area.caloocan.payments.clients',
                        'secretary.area.caloocan.clients.page',
                        'secretary.area.caloocan.clients.renewal.page',
                        'secretary.area.caloocan.clients.active.page',
                        'secretary.area.caloocan.clients.lapsed.page',
                        'secretary.area.caloocan.clients.profile.page',
                    )
                        ? 'active'
                        : '' }}">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item d-flex gap-2 align-items-center"
                                href="{{ route('secretary.caloocan.profile.page') }}">Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li>

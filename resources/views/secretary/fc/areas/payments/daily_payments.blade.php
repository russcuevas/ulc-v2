                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm border-1">
                        ...
                        <div class="m-4 text-end" style="margin-top: 0px !important;">
                            <a href="{{ route('secretary.area.fc.payments.print', $referenceNumber) }}" target="_blank"
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = `/secretary/fc/collect-payment/${paymentId}`;
        ...
        $(document).on('click', '.remind-payment-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = `/secretary/fc/remind-payment/${paymentId}`;
        ...
        $(document).on('click', '.no-payment-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = `/secretary/fc/no-payment/${paymentId}`;
    ...
    <script>
        document.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                fetch(`/secretary/fc/payments/${paymentId}/update-collection`, {
                        method: 'POST',
                        headers: {

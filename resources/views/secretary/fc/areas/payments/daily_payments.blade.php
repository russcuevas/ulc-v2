                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm border-1">
                        ...
                        <div class="m-4 text-end" style="margin-top: 0px !important;">
                            <a href="{{ route('secretary.area.fc.payments.print', $referenceNumber) }}"
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="d-flex flex-column align-items-end gap-2 mb-3 mt-5">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        ...
                                        {{-- Collect All --}}
                                        <form method="POST"
                                            action="{{ route('secretary.fc.payments.collect.all', $referenceNumber) }}"
                                        ...
                                        {{-- Remind Payment --}}
                                        <form method="POST"
                                            action="{{ route('secretary.fc.payments.remind.reference', $referenceNumber) }}"
                                        ...
                                        {{-- No Payment --}}
                                        <form method="POST"
                                            action="{{ route('secretary.fc.payments.no-payment.all', $referenceNumber) }}"

            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-sm border-1">
                        ...
                        <!-- ADD MODAL -->
                        @include('secretary.fc.client.modal.add_modal')
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{ route('secretary.fc.edit.clients.page', $client->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('secretary.fc.delete.clients.request', $client->id) }}"

        ...
        <div id="sidebarContent" class="d-none">
            ...
            <div class="nav flex-column nav-pills px-3 mt-2">
                <a href="{{ route('secretary.fc.dashboard.page') }}"
                    class="nav-link {{ request()->routeIs('secretary.fc.dashboard.page', 'secretary.fc.analytics.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-house"></i>
                    Dashboard
                </a>

                <a href="{{ route('secretary.fc.clients.page') }}"
                    class="nav-link 
                    {{ request()->routeIs('secretary.fc.clients.page', 'secretary.fc.edit.clients.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-users"></i>
                    Clients
                </a>
                <a href="{{ route('secretary.fc.area.page') }}"
                    class="nav-link 
                    {{ request()->routeIs(
                        'secretary.fc.area.page',
                        'secretary.area.fc.payments',
                        'secretary.area.fc.payments.clients',
                        'secretary.area.fc.clients.page',
                        'secretary.area.fc.clients.renewal.page',
                        'secretary.area.fc.clients.active.page',
                        'secretary.area.fc.clients.lapsed.page',
                        'secretary.area.fc.clients.profile.page',
                    )
                        ? 'active'
                        : '' }}">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item d-flex gap-2 align-items-center"
                                href="{{ route('secretary.fc.profile.page') }}">Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li>

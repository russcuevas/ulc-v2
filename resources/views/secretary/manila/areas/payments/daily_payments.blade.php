                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="d-flex flex-column align-items-end gap-2 mb-3 mt-5">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        ...
                                        {{-- Collect All --}}
                                        <form method="POST"
                                            action="{{ route('secretary.manila.payments.collect.all', $referenceNumber) }}"
                                        ...
                                        {{-- Remind Payment --}}
                                        <form method="POST"
                                            action="{{ route('secretary.manila.payments.remind.reference', $referenceNumber) }}"
                                        ...
                                        {{-- No Payment --}}
                                        <form method="POST"
                                            action="{{ route('secretary.manila.payments.no-payment.all', $referenceNumber) }}"

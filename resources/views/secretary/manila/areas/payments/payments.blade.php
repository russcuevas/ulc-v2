                    ...
                    <div class="card shadow-sm border-1">
                        <div class="d-flex justify-content-between align-items-start m-4">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                <form action="{{ route('secretary.area.manila.payments.request', $area->id) }}"
                                    method="POST">
                                    @csrf
                                ...
                                <tbody>
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('secretary.area.manila.payments.clients', $payment->reference_number) }}"
    ...
    <script>
        ...
        `,
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'GET';
                    form.action =
                        "{{ route('secretary.area.manila.payments.print.summary.collections', $area->id) }}";
                    form.target = '_blank';

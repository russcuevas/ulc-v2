            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-sm border-1">
                        ...
                        <!-- ADD MODAL -->
                        @include('secretary.manila.client.modal.add_modal')
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{ route('secretary.manila.edit.clients.page', $client->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('secretary.manila.delete.clients.request', $client->id) }}"

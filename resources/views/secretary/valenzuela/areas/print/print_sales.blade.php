        ...
        <section class="invoice">
            <div class="text-center mb-4">
                ...
                <div class="mt-2" style="font-size:12px;">
                    <strong>AREA:</strong>
                    {{ $allAreas ? 'ALL AREAS' : $loans->first()->areas_name ?? '' }} <br>

                    DATE From:
                    <strong>{{ \Carbon\Carbon::parse($from)->format('F d, Y') }}</strong>
                    To:
            ...
            <table class="table table-borderless summary-table">
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="1"><strong>NEW</strong></td>
                        <td colspan="6">[{{ $newCount }}]</td>
                    </tr>

                    <tr>
                        <td colspan="1"><strong>RENEWAL</strong></td>
                        <td colspan="6">[{{ $renewalCount }}]</td>
                    </tr>

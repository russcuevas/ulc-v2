        ...
        <button style="background-color: #ff6b35; color: white;" id="sidebarToggle"
        ...
        <nav class="navbar navbar-expand-lg bg-body shadow-sm d-lg-none mb-3 sticky-top">
            <div class="container-fluid">
                ...
                <span class="notification-badge"></span>
                    ...
                    <div class="user-avatar" data-bs-toggle="dropdown">{{ $user_initials }}</div>
        ...
        <div id="sidebarContent" class="d-none">
            ...
            <div class="nav flex-column nav-pills px-3 mt-2">
                <a href="{{ route('secretary.valenzuela.dashboard.page') }}"
                    class="nav-link {{ request()->routeIs('secretary.valenzuela.dashboard.page', 'secretary.valenzuela.analytics.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-house"></i>
                    Dashboard
                </a>

                <a href="{{ route('secretary.valenzuela.clients.page') }}"
                    class="nav-link 
                    {{ request()->routeIs('secretary.valenzuela.clients.page', 'secretary.valenzuela.edit.clients.page') ? 'active' : '' }}">
                    <i class="fa-solid fa-users"></i>
                    Clients
                </a>
                <a href="{{ route('secretary.valenzuela.area.page') }}"
                    class="nav-link 
                    {{ request()->routeIs(
                        'secretary.valenzuela.area.page',
                        'secretary.area.valenzuela.payments',
                        'secretary.area.valenzuela.payments.clients',
                        'secretary.area.valenzuela.clients.page',
                        'secretary.area.valenzuela.clients.renewal.page',
                        'secretary.area.valenzuela.clients.active.page',
                        'secretary.area.valenzuela.clients.lapsed.page',
                        'secretary.area.valenzuela.clients.profile.page',
                    )
                        ? 'active'
                        : '' }}">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item d-flex gap-2 align-items-center"
                                href="{{ route('secretary.valenzuela.profile.page') }}">Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li>

...
<body>
    ...
    <div class="main-content">
        <div class="row g-4 mb-4">
            <a style="margin-left: 11px;" class="nav-link text-primary"
                href="{{ route('secretary.valenzuela.dashboard.page') }}"><i class="fa-solid fa-arrow-left"></i>
                BACK TO DASHBOARD</a>
            ...
            @if ($fromMonth && $toMonth)
                <div class="alert alert-primary mb-3">
                    Showing data from
                    <strong>
                        {{ \Carbon\Carbon::parse($fromMonth)->format('F Y') }} –
                        {{ \Carbon\Carbon::parse($toMonth)->format('F Y') }}
                    </strong>
                </div>
            @endif
            <form id="filterForm" method="GET" action="" class="row g-4 mb-4">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <a href="analytics" class="btn btn-secondary w-100">Reset</a>
                </div>


            </form>
            @foreach ($data as $area)
                <h6 class="fw-bold">{{ $area['area'] }}</h6>
                    ...
                    <div class="card border-2 shadow-lg h-100 card-left-orange">
                        <div class="card-body">
                            ...
                            <h2 class="h3 fw-bold mb-1">
                                ₱{{ number_format($area['total_loans'], 2) }}
                            </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="card border-2 shadow-lg h-100 card-left-orange">
                        <div class="card-body">
                            ...
                            <h2 class="h3 fw-bold mb-1">
                                {{ number_format($area['total_clients']) }} </h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="card border-2 shadow-lg h-100 card-left-orange">
                        <div class="card-body">
                            ...
                            <div class="mb-3">{{ $area['collector'] }}</div>
                        </div>
                    </div>
                </div>
            @endforeach

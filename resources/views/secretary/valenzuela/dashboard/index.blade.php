...
<body>
    ...
    <div class="main-content">
        <div class="row g-4 mb-4">
            ...
            <a style="text-align: right; text-decoration: none;"
                href="{{ route('secretary.valenzuela.analytics.page') }}">View summary details</a>
        </div>
                ...
                <div class="card border-2 shadow-lg h-100">
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('secretary.valenzuela.notification.page') }}"
    ...
    <script>
        ...
        function fetchSecretaryNotifications() {
            fetch("{{ route('secretary.valenzuela.fetch_notifications') }}")
